          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="text-white/90 hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 hover:bg-blue-400/10 hover:scale-105 font-[Roboto] flex items-center space-x-1 cursor-pointer"
              >
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-3">
            {isAuthenticated ? (
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={logout}
                  className="text-white/80 hover:text-red-400 px-4 py-2 text-sm font-medium transition-all duration-300 hover:bg-red-400/10 rounded-lg font-[Roboto] border border-red-400/30 hover:border-red-400/60 cursor-pointer"
